//#include "platform/monitorInfo.h"
//
...
//        desc.resolution = math::Vector2i(std::abs(info.rcMonitor.left - info.rcMonitor.right), std::abs(info.rcMonitor.top - info.rcMonitor.bottom));
//
//        desc.physicalSize = math::Vector2f(wInch, hInch);
//
//        auto vPpi = math::Vector2f(desc.resolution) / desc.physicalSize;
