...
add_requires("vulkan-hpp", "vulkan-memory-allocator-hpp", "assimp", "eigen", "robin-map", "spirv-reflect", "boost", "glfw")
...
target("driver")
    ...
    add_packages("eigen", "vulkan-hpp", "vulkan-memory-allocator-hpp", "spirv-reflect")
    add_deps("common")
