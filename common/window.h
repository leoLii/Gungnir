...
class GUNGNIR_API Window : public Object
{
    GUNGNIR_OBJECT(Window)
public:
    ...
    struct Desc
    {
        ...
        std::string title = "Gungnir Engine";  ///< Window title.
     ...
     */
     math::Vector2i getClientAreaSize() const { return {mDesc.width, mDesc.height}; }
...
private:
    ...
    math::Vector2f mMouseScale;
    const math::Vector2f& getMouseScale() const { return mMouseScale; }
